        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="page-gopay text-center justify-content-center bg-light">
                    <?php
                    $bayar=mysqli_query($con,"SELECT * from pembayaran where metode='gopay'");
                    $b=mysqli_fetch_array($bayar);
                    ?>
                    <img src="<?php echo $b['logo'];?>" alt="gopay_logo" style="max-width: 200px;" class="mb-3"><hr>
                    <p>
                       <b>Scan kode QR di bawah dengan aplikasi GO-JEK Anda untuk melanjutkan.</b> 
                    </p>
                    <img src="./assets/images/qr-gopay.jpg" alt="" style="max-width: 200px;">
