                              ...
                              <div class="row">
                                ...
                                <div class="col-4">
                                  <select class="form-select">
                                    ...
                                    <option name='server' value="America">America</option>
                                    <option name='server' value="Europe">Europe</option>
                                    <option name='server' value="Asia">Asia</option>
                                    <option name='server' value="TW, HK, MO">TW, HK, MO</option>
                                  </select>
                                </div>
                              </div>
