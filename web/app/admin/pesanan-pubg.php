...
<head>
    ...
    <title>Pesanan PUBG - WidanStore</title>
                    ...
                    <nav>
                        <ul class="metismenu" id="menu">
							...
							<li class="active">
                                ...
                                <ul class="collapse">
                                    <li class="active"><a href="./pesanan-pubg">PUBG Mobile</a></li>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="d-sm-flex mb-3 justify-content-between align-items-center">
									<h2>Daftar Pesanan <b class="text-primary">PUBG Mobile</b> </h2>
								</div>
                                    <div class="data-tables datatable-dark">
										<table id="dataTable3" class="display" style="width:100%">
                                            ...
                                            <tbody>
                                                <?php
                                                    $daftar=mysqli_query($con,"SELECT * from order_pubg order by order_id ASC");
                                                    $no=1;
												...
												<tr>
                                                    ...
                                                    <td><?php echo $p['id_pubg']; ?></td>
                                                    <td><?php echo $p['nama_user']; ?></td>
                                                    <td><?php echo $p['item'] ; ?> <i class="ri-money-dollar-box-line"></i></td>
