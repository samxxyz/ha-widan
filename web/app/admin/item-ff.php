<?php 
	...
	if(isset($_POST["additem"])) {
		...
		$tambah = mysqli_query($con, "insert into harga_ff(item, harga) values('$namaitem','$harga')");
		
        if($tambah){
		    header('location:./item-ff');
        } else{
                        ...
                        <ul class="metismenu" id="menu">
							...
							<li class="active">
                                ...
                                <ul class="collapse">
                                    ...
                                    <li class="active"><a href="./item-ff">Free Fire</a></li>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="d-sm-flex mb-3 justify-content-between align-items-center">
									<h2>Daftar Item <b class="text-danger">Free Fire</b> </h2>
                                    ...
                                    <div class="data-tables datatable-dark">
										<table id="dataTable3" class="display" style="width:100%">
											...
											<tbody>
												<?php
                                                    $item=mysqli_query($con,"SELECT * from harga_ff order by id_voucher ASC");
                                                    $no=1;
				...
				<div class="modal-dialog">
					<div class="modal-content">
						...
						<div class="modal-body">
							<form action="./item-ff.php" method="post" enctype="multipart/form-data" >
