...
<head>
    ...
    <title>Pesanan Free Fire - WidanStore</title>
                        ...
                        <ul class="metismenu" id="menu">
							...
							<li class="active">
                                ...
                                <ul class="collapse">
                                    ...
                                    <li class="active"><a href="./pesanan-ff">Free Fire</a></li>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="d-sm-flex mb-3 justify-content-between align-items-center">
									<h2>Daftar Pesanan <b class="text-danger">Free Fire</b> </h2>
								</div>
                                    <div class="data-tables datatable-dark">
										<table id="dataTable3" class="display" style="width:100%">
                                            ...
                                            <tbody>
                                                <?php
                                                    $daftar=mysqli_query($con,"SELECT * from order_ff order by order_id ASC");
                                                    $no=1;
												...
												<tr>
                                                    ...
                                                    <td><?php echo $p['id_ff']; ?></td>
                                                    <td><?php echo $p['nama_user']; ?></td>
                                                    <td><?php echo $p['item'] ; ?> <i class="ri-vip-diamond-line"></i></td>
