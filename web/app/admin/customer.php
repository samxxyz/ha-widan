...
<head>
    ...
    <title>Kelola Pelanggan - WidanStore</title>
                ...
                <div class="menu-inner">
                    <nav>
                        <ul class="metismenu" id="menu">
							...
							<li class="active"><a href="./customer"><span>Kelola Pelanggan</span></a></li>
                                ...
                                <div class="d-sm-flex mb-3 justify-content-between align-items-center">
                                    ...
                                    <div class="data-tables datatable-dark">
										<table id="dataTable3" class="display" style="width:100%">
                                            ...
                                            <tbody>
                                                <?php
                                                    $pelanggan=mysqli_query($con,"SELECT * from login where role='Member' order by id_user ASC");
                                                    $no=1;
