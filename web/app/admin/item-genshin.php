<?php 
	...
	if(isset($_POST["additem"])) {
		...
		$tambah = mysqli_query($con, "insert into harga_genshin(item, harga) values('$namaitem','$harga')");
		
        if($tambah){
		    header('location:./item-genshin');
        } else{
                ...
                <div class="menu-inner">
                    <nav>
                        <ul class="metismenu" id="menu">
                            <h3 style="color: #ec6090;" class="mb-3 ps-2 ms-4 text-center"><b>AzemStore.</b></h3>
							...
							<li class="active">
                                ...
                                <ul class="collapse">
									...
									<li class="active"><a href="./item-genshin">Genshin Impact</a></li>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="d-sm-flex mb-3 justify-content-between align-items-center">
									<h2>Daftar Item <b class="text-info">Genshin Impact</b> </h2>
                                    ...
                                    <div class="data-tables datatable-dark">
										<table id="dataTable3" class="display" style="width:100%">
											...
											<tbody>
												<?php
                                                    $item=mysqli_query($con,"SELECT * from harga_genshin order by id_voucher ASC");
                                                    $no=1;
												...
												<tr>
													...
													<td><?php echo $p['item'] ?> 
                                                    <?php 
                                                    if($p['item']=='Blessing of the Welkin Moon'){
                                                        echo '<img src="../assets/images/welkin.png" alt="welkin" style="max-width: 25px; ">';
                                                    }
                                                    else{echo $p['gambar'];} ?></td>
				...
				<div class="modal-dialog">
					<div class="modal-content">
						...
						<div class="modal-body">
							<form action="./item-genshin.php" method="post" enctype="multipart/form-data" >
