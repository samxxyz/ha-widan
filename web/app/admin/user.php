<?php 
    ...
    if(isset($_POST["adduser"])) {
		...
		$tambah = mysqli_query($con, "insert into login(nama_lengkap, email, username, password, role) values('$nama_lengkap','$email','$username','$pass','$role')");
...
<head>
    ...
    <title>Kelola Staff - WidanStore</title>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="d-sm-flex mb-3 justify-content-between align-items-center">
									<h2>Daftar Staff</h2>
                                    <button style="margin-bottom:20px" data-toggle="modal" data-target="#myModal" class="btn btn-primary col-md-2"><b>Tambah Staff</b></button>
								</div>
                                    <div class="data-tables datatable-dark">
										<table id="dataTable3" class="display" style="width:100%">
                                            ...
                                            <tbody>
                                                <?php
                                                    $pelanggan=mysqli_query($con,"SELECT * from login where role='Admin' order by id_user ASC");
                                                    $no=1;
						...
						<div class="modal-body">
							<form action="./user" method="post" enctype="multipart/form-data" >
								...
								<div class="form-group">
									...
									<input name="uname" type="text" class="form-control" required autofocus>
								</div>
								<div class="form-group">
									<label>Email</label>
