<?php 
	...
	if(isset($_POST["addmetode"])) {
		...
		$tambah = mysqli_query($con, "insert into pembayaran(metode, no) values('$metode','$nomer')");
...
<head>
    ...
    <title>Kelola Pembayaran - WidanStore</title>
                        ...
                        <ul class="metismenu" id="menu">
							...
							<li class="active">
                                ...
                                <ul class="collapse">
									...
									<li class="active"><a href="./pembayaran">Metode Pembayaran</a></li>
                                </ul>
                            </li>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="d-sm-flex mb-3 justify-content-between align-items-center">
									...
									<button style="margin-bottom:20px" data-toggle="modal" data-target="#myModal" class="btn btn-danger col-md-2"><b>Tambah Metode</b></button>
                                </div>
                                    <div class="data-tables datatable-dark">
										<table id="dataTable3" class="display" style="width:100%">
											...
											<tbody>
												<?php
                                                    $metode=mysqli_query($con,"SELECT * from pembayaran order by id_bayar ASC");
                                                    $no=1;
				...
				<div class="modal-dialog">
					<div class="modal-content">
						...
						<div class="modal-footer">
								...
								<input name="addmetode" type="submit" class="btn btn-primary" value="Tambah">
						</div>
						</form>
					</div>
				</div>
