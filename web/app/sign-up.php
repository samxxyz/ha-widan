...
if(isset($_POST['adduser']))
    ...
    $username = $_POST['username'];
		...
		if ($tambahuser){
		  echo "<meta http-equiv='refresh' content='1; url=./sign-in'/>";
		} else { echo "<div class='alert alert-warning'>Gagal mendaftar, silakan coba lagi.</div>
		  <meta http-equiv='refresh' content='1; url=./sign-up'/> ";
		}		
	};
?>
                ...
                <div class="col-sm-6 text-center">
                    ...
                    <div class="form">
                      ...
                      <div class="text-white">
                          <span>Sudah punya akun? <a href="./sign-in" class="link login-link">Login</a></span><br>
