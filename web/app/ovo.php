        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="page-gopay text-center justify-content-center bg-light">
                    <?php
                    $bayar=mysqli_query($con,"SELECT * from pembayaran where metode='Ovo'");
                    $b=mysqli_fetch_array($bayar);
                    ?>
                    <img src="<?php echo $b['logo'];?>" alt="ovo_logo" style="max-width: 200px;" class="mb-2"><hr>
                    <p>
                       <b>Scan kode QR di bawah dengan aplikasi OVO Anda untuk melanjutkan.</b> 
                    </p>
